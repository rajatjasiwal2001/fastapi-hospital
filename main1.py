...
app.add_middleware(SessionMiddleware, secret_key=os.getenv("SESSION_KEY", "super-secret-session-key"))
...
def connection():
    ...
    conn = pymysql.connect(
        ...
        user=os.getenv("DB_USER", "rajatjaiswal"),
        password=os.getenv("DB_PASS", "rajat@2004"),
...
async def root(request: Request):
    ...
    return templates.TemplateResponse(
        "home.html",
        {"request": request, "message": "Hospital Patient Record System", "user": user},
    )
